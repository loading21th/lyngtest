#define NGX_CONFIGURE " --prefix=/usr/home/liyao5/work/bin/lyngtest-dev --with-pcre=./3party/pcre-8.42 --with-pcre-jit --with-http_stub_status_module --with-http_ssl_module --with-openssl=./3party/openssl-1.1.1 --with-openssl-opt=enable-tls1_3 --add-module=modules/headers-more-nginx-module-0.33 --add-module=modules/ngx_devel_kit-0.3.0 --add-module=modules/lua-nginx-module-0.10.15 --with-ld-opt='-lstdc++ -Wl,-rpath,/usr/home/liyao5/work/bin/lyngtest-dev/luajit-2.1-20180420/lib'"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/home/liyao5/work/bin/lyngtest-dev/"
#endif
